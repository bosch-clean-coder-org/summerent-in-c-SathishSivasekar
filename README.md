...
- Enter Reflections: Update the details in Refelections section .
...
1. Apply all the coding standard guidelines while written the code
2. Be a habit as even written the dummy code also using codeing rules
3. Update all the understanding to the team and make our contribute project code has good code-quality  
